...
abstract class TypedMapAccessorsGenerator extends BoilerplateDeclarationGenerator {
  ...
  String _generateAccessorsMixin() {
    ...
    // Preserve annotations authored by the consumer on any public APIs generated by the builder
    for (final annotation in node.metadata) {
      if (!accessorsMixinName.startsWith('_') &&
          !overReactBoilerplateAnnotations.contains(annotation.name.name)) {
