...
const _outputExtension = '.over_react.g.dart';


Builder overReactBuilderTestOfPartBuilder(BuilderOptions options) =>
    new PartBuilder([new OverReactGenerator()], _outputExtension,
...
//      await buildStep.writeAsString(outputId, contentBuffer.toString());
