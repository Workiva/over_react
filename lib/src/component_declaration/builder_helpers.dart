...
abstract class UiComponent<TProps extends UiProps>
    extends component_base.UiComponent<TProps> with GeneratedClass {
  ...
  Iterable<component_base.ConsumedProps> get $defaultConsumedProps =>
      throw UngeneratedError(member: #$defaultConsumedProps);
  ...
  TProps typedPropsFactory(Map propsMap) =>
      throw UngeneratedError(member: #typedPropsFactory);
}
...
abstract class UiStatefulComponent<TProps extends UiProps,
  ...
  @override
  @toBeGenerated
  TState typedStateFactory(Map stateMap) => throw UngeneratedError(
...
abstract class UiProps extends component_base.UiProps with GeneratedClass {
  ...
  String get propKeyNamespace =>
      throw UngeneratedError(member: #propKeyNamespace);

  @override
  @toBeGenerated
  Map get props => throw UngeneratedError(member: #props);
  @override
  @toBeGenerated
  ReactComponentFactoryProxy get componentFactory =>
      throw UngeneratedError(member: #componentFactory);
}
...
abstract class UiState extends component_base.UiState with GeneratedClass {
  ...
  @override
  @toBeGenerated
  Map get state => throw UngeneratedError(member: #state);
}
...
class UngeneratedError extends Error implements UnimplementedError {
  ...
  UngeneratedError({String message, Symbol member})
      : this.message =
            message ?? '`$member` should be implemented by code generation';

  @override
  String toString() => 'UngeneratedError: $message.\n\n'
