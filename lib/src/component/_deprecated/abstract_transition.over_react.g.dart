...
mixin _$AbstractTransitionPropsAccessorsMixin implements _$AbstractTransitionProps {
  @override
  Map get props;
...
mixin _$AbstractTransitionStateAccessorsMixin implements _$AbstractTransitionState {
  @override
  Map get state;
  ...
  @override
  TransitionPhase? get transitionPhase => (state[_$key__transitionPhase___$AbstractTransitionState] ?? null) as TransitionPhase?;
  /// The current phase of transition the [AbstractTransitionComponent] is in.
  ///
  /// Default:  [AbstractTransitionComponent.initiallyShown] ? [TransitionPhase.SHOWN] : [TransitionPhase.HIDDEN]
  ///
  /// <!-- Generated from [_$AbstractTransitionState.transitionPhase] -->
  @override
  set transitionPhase(TransitionPhase? value) => state[_$key__transitionPhase___$AbstractTransitionState] = value;
  /* GENERATED CONSTANTS */
  static const StateDescriptor _$prop__transitionPhase___$AbstractTransitionState = StateDescriptor(_$key__transitionPhase___$AbstractTransitionState);
  static const String _$key__transitionPhase___$AbstractTransitionState = 'AbstractTransitionState.transitionPhase';

  static const List<StateDescriptor> $state = [_$prop__transitionPhase___$AbstractTransitionState];
  static const List<String> $stateKeys = [_$key__transitionPhase___$AbstractTransitionState];
}
