...
class DomProps extends component_base.UiProps
  ...
  DomProps(this.componentFactory, [Map props])
      : this.props = props ?? new JsBackedMap();
...
abstract class Dom {
  ...
  /// optionally backed by a specified map.
  static DomProps base([Map backingMap]) =>
      new DomProps(react.base, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps blockquote([Map backingMap]) =>
      new DomProps(react.blockquote, backingMap);

  /// Returns a new builder that renders a `<body>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps body([Map backingMap]) =>
      new DomProps(react.body, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps colgroup([Map backingMap]) =>
      new DomProps(react.colgroup, backingMap);

  /// Returns a new builder that renders a `<data>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps data([Map backingMap]) =>
      new DomProps(react.data, backingMap);

  /// Returns a new builder that renders a `<datalist>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps datalist([Map backingMap]) =>
      new DomProps(react.datalist, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps details([Map backingMap]) =>
      new DomProps(react.details, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps dialog([Map backingMap]) =>
      new DomProps(react.dialog, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps head([Map backingMap]) =>
      new DomProps(react.head, backingMap);

  /// Returns a new builder that renders a `<header>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps header([Map backingMap]) =>
      new DomProps(react.header, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps html([Map backingMap]) =>
      new DomProps(react.html, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps iframe([Map backingMap]) =>
      new DomProps(react.iframe, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps input([Map backingMap]) =>
      new DomProps(react.input, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps keygen([Map backingMap]) =>
      new DomProps(react.keygen, backingMap);

  /// Returns a new builder that renders a `<label>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps label([Map backingMap]) =>
      new DomProps(react.label, backingMap);

  /// Returns a new builder that renders a `<legend>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps legend([Map backingMap]) =>
      new DomProps(react.legend, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps link([Map backingMap]) =>
      new DomProps(react.link, backingMap);

  /// Returns a new builder that renders a `<main>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps main([Map backingMap]) =>
      new DomProps(react.main, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps noscript([Map backingMap]) =>
      new DomProps(react.noscript, backingMap);

  /// Returns a new builder that renders an `<object>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps object([Map backingMap]) =>
      new DomProps(react.object, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps optgroup([Map backingMap]) =>
      new DomProps(react.optgroup, backingMap);

  /// Returns a new builder that renders an `<option>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps option([Map backingMap]) =>
      new DomProps(react.option, backingMap);

  /// Returns a new builder that renders an `<output>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps output([Map backingMap]) =>
      new DomProps(react.output, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps param([Map backingMap]) =>
      new DomProps(react.param, backingMap);

  /// Returns a new builder that renders a `<picture>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps picture([Map backingMap]) =>
      new DomProps(react.picture, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps progress([Map backingMap]) =>
      new DomProps(react.progress, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps ruby([Map backingMap]) =>
      new DomProps(react.ruby, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps summary([Map backingMap]) =>
      new DomProps(react.summary, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps table([Map backingMap]) =>
      new DomProps(react.table, backingMap);

  /// Returns a new builder that renders a `<tbody>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps tbody([Map backingMap]) =>
      new DomProps(react.tbody, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps textarea([Map backingMap]) =>
      new DomProps(react.textarea, backingMap);

  /// Returns a new builder that renders a `<tfoot>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps tfoot([Map backingMap]) =>
      new DomProps(react.tfoot, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps thead([Map backingMap]) =>
      new DomProps(react.thead, backingMap);

  /// Returns a new builder that renders a `<time>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps time([Map backingMap]) =>
      new DomProps(react.time, backingMap);

  /// Returns a new builder that renders a `<title>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps title([Map backingMap]) =>
      new DomProps(react.title, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps track([Map backingMap]) =>
      new DomProps(react.track, backingMap);
  ...
  /// optionally backed by a specified map.
  static DomProps variable([Map backingMap]) =>
      new DomProps(react.variable, backingMap);

  /// Returns a new builder that renders a `<video>` tag with getters/setters for all DOM-related React props,
  /// optionally backed by a specified map.
  static DomProps video([Map backingMap]) =>
      new DomProps(react.video, backingMap);
  ...
  /// optionally backed by a specified map.
  static SvgProps svgVideo([Map backingMap]) =>
      new SvgProps(react.video, backingMap);

  /// Returns a new builder that renders a `<view>` tag with getters/setters for all SVG-related React props,
  /// optionally backed by a specified map.
  static SvgProps view([Map backingMap]) =>
      new SvgProps(react.view, backingMap);

  /// Returns a new builder that renders a `<vkern>` tag with getters/setters for all SVG-related React props,
  /// optionally backed by a specified map.
  static SvgProps vkern([Map backingMap]) =>
      new SvgProps(react.vkern, backingMap);
}
