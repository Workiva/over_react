...
@Props()
//// ignore: mixin_of_non_class,undefined_class
class _$BasicProps extends UiProps with pm.ExamplePropsMixinClass, pm.$ExamplePropsMixinClass, pm.MixesInOtherMixinMixin<String>, pm.$MixesInOtherMixinMixin<String> {
