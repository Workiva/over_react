...
mixin $BasicPartOfLibPropsMixin
    implements BasicPartOfLibPropsMixin {
  @override
  Map get props;
...
$BasicPartOfLibProps $BasicPartOfLib([Map backingProps]) =>
    backingProps == null
        ...
        : new $BasicPartOfLibProps(backingProps);

// Concrete props implementation.
//
// Implements constructor and backing map, and links up to generated component factory.
class $BasicPartOfLibProps extends BasicPartOfLibProps
...
mixin $BasicPartOfLibStateMixin
    implements BasicPartOfLibStateMixin {
  @override
  Map get state;
...
class $BasicPartOfLibState extends BasicPartOfLibState
...
class _$BasicPartOfLibComponent extends BasicPartOfLibComponent {
  ...
  @override
  $BasicPartOfLibProps typedPropsFactory(Map backingMap) =>
      new $BasicPartOfLibProps(backingMap);
  ...
  @override
  $BasicPartOfLibState typedStateFactory(Map backingMap) =>
      new $BasicPartOfLibState(backingMap);
...
mixin $SubPartOfLibPropsMixin
    implements SubPartOfLibPropsMixin {
  @override
  Map get props;
...
$SubPartOfLibProps $SubPartOfLib([Map backingProps]) => backingProps == null
    ? new _$$SubPartOfLibProps$JsMap(new JsBackedMap())
    : new $SubPartOfLibProps(backingProps);

// Concrete props implementation.
//
// Implements constructor and backing map, and links up to generated component factory.
class $SubPartOfLibProps extends SubPartOfLibProps
    with SubPartOfLibPropsMixin, $SubPartOfLibPropsMixin {
...
class _$SubPartOfLibComponent extends SubPartOfLibComponent {
  ...
  @override
  $SubPartOfLibProps typedPropsFactory(Map backingMap) =>
      new $SubPartOfLibProps(backingMap);
...
mixin $SuperPartOfLibPropsMixin
    implements SuperPartOfLibPropsMixin {
