...
@Deprecated('This API is for use only within generated code.'
    ' Do not reference it in your code, as it may change at any time.')
abstract class _$$BasicPropsMixin extends UiProps
    with
        BasicPropsMixin,
        $BasicPropsMixin // If this generated mixin is undefined, it's likely because BasicPropsMixin is not a valid `mixin`-based props mixin, or because it is but the generated mixin was not exported. Check the declaration of BasicPropsMixin.
{
  ...
  factory _$$BasicPropsMixin(Map backingMap) {
    if (backingMap == null || backingMap is JsBackedMap) {
      return _$$BasicPropsMixin$JsMap(backingMap);
    } else {
      return _$$BasicPropsMixin$PlainMap(backingMap);
    }
  }
...
@Deprecated('This API is for use only within generated code.'
    ' Do not reference it in your code, as it may change at any time.')
class _$$BasicPropsMixin$PlainMap extends _$$BasicPropsMixin {
  // This initializer of `_props` to an empty map, as well as the reassignment
  // of `_props` in the constructor body is necessary to work around a DDC bug: https://github.com/dart-lang/sdk/issues/36217
  _$$BasicPropsMixin$PlainMap(Map backingMap)
      : this._props = {},
        super._() {
...
@Deprecated('This API is for use only within generated code.'
    ' Do not reference it in your code, as it may change at any time.')
class _$$BasicPropsMixin$JsMap extends _$$BasicPropsMixin {
  // This initializer of `_props` to an empty map, as well as the reassignment
  // of `_props` in the constructor body is necessary to work around a DDC bug: https://github.com/dart-lang/sdk/issues/36217
  _$$BasicPropsMixin$JsMap(JsBackedMap backingMap)
