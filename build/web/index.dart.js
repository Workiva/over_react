...
(function() {
  ...
  init();
  init.mangledNames = {set$props: "props=", get$props: "props", call$0: "call:0", call$1: "call:1", call$1$growable: "call:0:growable", call$2: "call:2", call$2$onError: "call:1:onError", call$2$runGuarded: "call:1:runGuarded", call$3: "call:3", call$3$onDone$onError: "call:1:onDone:onError", call$4: "call:4", call$4$cancelOnError$onDone$onError: "call:1:cancelOnError:onDone:onError", call$5: "call:5", call$6: "call:6", call$7: "call:7", componentFactory$0: "componentFactory:0"};
  ...
  function setupProgram(programData, typesOffset) {
    ...
    function finishClasses(processedClasses) {
      ...
      var objectClassObject = processedClasses.collected.Object, shortNames = "set$caption,set$className,set$dartDefaultProps,set$disabled,set$displayName,set$href,set$isMounted,set$key,set$next,set$ref,set$target,set$type,set$value,get$$char,get$altKey,get$attributes,get$bubbles,get$button,get$buttons,get$cancelable,get$caption,get$changedTouches,get$charCode,get$checked,get$children,get$className,get$clientX,get$clientY,get$clipboardData,get$ctrlKey,get$currentTarget,get$dartDefaultProps,get$dataTransfer,get$defaultPrevented,get$deltaMode,get$deltaX,get$deltaY,get$deltaZ,get$detail,get$displayName,get$dropEffect,get$effectAllowed,get$error,get$eventPhase,get$files,get$header,get$href,get$id,get$internal,get$isEmpty,get$isMounted,get$isTrusted,get$iterator,get$key,get$keyCode,get$keys,get$length,get$locale,get$location,get$max,get$metaKey,get$min,get$name,get$nativeEvent,get$next,get$onClick,get$pageX,get$pageY,get$refs,get$relatedTarget,get$repeat,get$result,get$screenX,get$screenY,get$shiftKey,get$size,get$target,get$targetTouches,get$timeStamp,get$touches,get$type,get$types,get$value,get$view,$add,$and,$div,$ge,$gt,$index,$indexSet,$le,$lt,$mul,$not,$shl,$shr,$sub,$tdiv,$xor,__isolate_helper$_add$1,_async$_add$1,_replaceChild$2,add$1,addAll$1,clear$0,compareTo$1,contains$1,containsKey$1,forEach$1,indexOf$1,map$1,matchAsPrefix$2,preventDefault$0,remove$0,remove$1,render$0,replaceWith$1,send$1,setState$1,startsWith$1,stopPropagation$0,sublist$1,substring$1,substring$2,toList$0,set$_collection$_next,set$_collection$_previous,set$_contents,set$_next,set$_nextListener,set$_previous,set$captionProps,set$component,set$hashMapCellValue,set$initialized,set$nextProps,set$showCaption,set$skin,get$__internal$_name,get$_chainSource,get$_collection$_element,get$_collection$_next,get$_collection$_previous,get$_contents,get$_duration,get$_error,get$_hasError,get$_id,get$_isChained,get$_isClosed,get$_isComplete,get$_next,get$_nextListener,get$_previous,get$_resultOrListeners,get$_scheduleMicrotask,get$_state,get$_value,get$_zone,get$callback,get$captionProps,get$component,get$componentBuilderFactory,get$controlPort,get$current,get$delayedEvents,get$elementType,get$errorMessage,get$errorZone,get$handlesComplete,get$handlesError,get$handlesValue,get$hasErrorCallback,get$hashMapCellKey,get$hashMapCellValue,get$headerProps,get$headerSize,get$inMilliseconds,get$isActive,get$isAnimated,get$isBlock,get$isDisabled,get$isMethod,get$isNullable,get$isPaused,get$isPill,get$isRequired,get$isStriped,get$isolateStatics,get$memberName,get$namedArguments,get$nextProps,get$nextState,get$positionalArguments,get$prevState,get$reactClass,get$rootNodeProps,get$setStateCallbacks,get$showCaption,get$showPercentComplete,get$skin,get$stackTrace,get$transactionalSetStateCallbacks,get$typeName,get$zone,__isolate_helper$_close$0,_addError$2,_addListener$1,_clearPendingComplete$0,_cloneResult$1,_complete$1,_completeError$2,_prependListeners$1,_removeListeners$0,_setChained$1,_setErrorObject$1,_setPendingComplete$0,_setValue$1,_updateGlobalState$0,addProps$1,cancelSchedule$0,componentBuilderFactory$0,componentDidMount$0,componentDidUpdate$2,componentWillMount$0,componentWillReceiveProps$1,componentWillUnmount$0,componentWillUpdate$2,createTimer$2,errorCallback$2,eval$1,getDefaultProps$0,handleControlMessage$1,handleError$1,handleUncaughtError$2,handleValue$1,handleWhenComplete$0,inSameErrorZone$1,initComponentInternal$4,initStateInternal$0,lookup$1,matchesErrorTest$1,moveNext$0,perform$1,process$0,registerBinaryCallback$1,registerCallback$1,registerUnaryCallback$1,run$1,runBinary$3,runBinaryGuarded$3,runGuarded$1,runUnary$2,runUnaryGuarded$2,schedule$1,scheduleMicrotask$1,shouldComponentUpdate$2,then$1,toRti$0,transferComponentState$0,whenComplete$1".split(",");
      var longNames = "caption=,className=,dartDefaultProps=,disabled=,displayName=,href=,isMounted=,key=,next=,ref=,target=,type=,value=,char,altKey,attributes,bubbles,button,buttons,cancelable,caption,changedTouches,charCode,checked,children,className,clientX,clientY,clipboardData,ctrlKey,currentTarget,dartDefaultProps,dataTransfer,defaultPrevented,deltaMode,deltaX,deltaY,deltaZ,detail,displayName,dropEffect,effectAllowed,error,eventPhase,files,header,href,id,internal,isEmpty,isMounted,isTrusted,iterator,key,keyCode,keys,length,locale,location,max,metaKey,min,name,nativeEvent,next,onClick,pageX,pageY,refs,relatedTarget,repeat,result,screenX,screenY,shiftKey,size,target,targetTouches,timeStamp,touches,type,types,value,view,+,&,/,>=,>,[],[]=,<=,<,*,~,<<,>>,-,~/,^,_add,_add,_replaceChild,add,addAll,clear,compareTo,contains,containsKey,forEach,indexOf,map,matchAsPrefix,preventDefault,remove,remove,render,replaceWith,send,setState,startsWith,stopPropagation,sublist,substring,substring,toList,_next=,_previous=,_contents=,_next=,_nextListener=,_previous=,captionProps=,component=,hashMapCellValue=,initialized=,nextProps=,showCaption=,skin=,_name,_chainSource,_element,_next,_previous,_contents,_duration,_error,_hasError,_id,_isChained,_isClosed,_isComplete,_next,_nextListener,_previous,_resultOrListeners,_scheduleMicrotask,_state,_value,_zone,callback,captionProps,component,componentBuilderFactory,controlPort,current,delayedEvents,elementType,errorMessage,errorZone,handlesComplete,handlesError,handlesValue,hasErrorCallback,hashMapCellKey,hashMapCellValue,headerProps,headerSize,inMilliseconds,isActive,isAnimated,isBlock,isDisabled,isMethod,isNullable,isPaused,isPill,isRequired,isStriped,isolateStatics,memberName,namedArguments,nextProps,nextState,positionalArguments,prevState,reactClass,rootNodeProps,setStateCallbacks,showCaption,showPercentComplete,skin,stackTrace,transactionalSetStateCallbacks,typeName,zone,_close,_addError,_addListener,_clearPendingComplete,_cloneResult,_complete,_completeError,_prependListeners,_removeListeners,_setChained,_setErrorObject,_setPendingComplete,_setValue,_updateGlobalState,addProps,cancelSchedule,componentBuilderFactory,componentDidMount,componentDidUpdate,componentWillMount,componentWillReceiveProps,componentWillUnmount,componentWillUpdate,createTimer,errorCallback,eval,getDefaultProps,handleControlMessage,handleError,handleUncaughtError,handleValue,handleWhenComplete,inSameErrorZone,initComponentInternal,initStateInternal,lookup,matchesErrorTest,moveNext,perform,process,registerBinaryCallback,registerCallback,registerUnaryCallback,run,runBinary,runBinaryGuarded,runGuarded,runUnary,runUnaryGuarded,schedule,scheduleMicrotask,shouldComponentUpdate,then,toRti,transferComponentState,whenComplete".split(",");
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, null, null, 14, 0, null, 47, 30, 38, 52, 41, 23, 50],
    ...
    _Completer: {
      ...
      }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 33, 0, 4, 8]
    },
    _AsyncCompleter: {
      "^": "_Completer;future",
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 40, 0, 4, 8],
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 29, 4, 8],
    ...
    DomIterator: {
      ...
      }, "next$0", "call$1", "call$0", "get$next", 0, 2, 37, 0],
      "%": "Iterator"
    },
    DomRectReadOnly: {
      "^": "Interceptor;",
    ...
    InputElement: {
      "^": "HtmlElement;checked=,disabled},files=,max=,min=,name=,size=,type%,value%",
      $isElement: 1,
      $isInterceptor: 1,
      $isEventTarget: 1,
      $isNode: 1,
    ...
    Cursor: {
      ...
      }, "next$0", "call$1", "call$0", "get$next", 0, 2, 19, 0],
      "%": ";IDBCursor"
    },
    CursorWithValue: {
      "^": "Cursor;",
    ...
    main: [function() {
      ...
      t2.set$className(0, "btn-toolbar");
      t3 = $.$get$Button().call$0().call$1("Primary");
      t4 = $.$get$Button().call$0();
      t4.set$skin(C.ButtonSkin_sEs);
      t4 = t4.call$1("Secondary");
      t5 = $.$get$Button().call$0();
      t5.set$skin(C.ButtonSkin_qRH);
      t5 = t5.call$1("Success");
      t6 = $.$get$Button().call$0();
      t6.set$skin(C.ButtonSkin_wqt);
      t6 = t6.call$1("Info");
      t7 = $.$get$Button().call$0();
      t7.set$skin(C.ButtonSkin_0);
      t7 = t7.call$1("Warning");
      t8 = $.$get$Button().call$0();
      t8.set$skin(C.ButtonSkin_ccO);
      t8 = t8.call$1("Danger");
      t9 = $.$get$Button().call$0();
      J.set$href$x(t9, "#");
      t9.set$skin(C.ButtonSkin_MYu);
      t1.call$2(t2.call$7(t3, t4, t5, t6, t7, t8, t9.call$1("Link")), document.querySelector(".component-demo__mount--button"));
      $.$get$render().call$2($.$get$ListGroup().call$0().call$4($.$get$ListGroupItem().call$0().call$1("Dapibus ac facilisis in"), $.$get$ListGroupItem().call$0().call$1("Cras sit amet nibh libero"), $.$get$ListGroupItem().call$0().call$1("Porta ac consectetur ac"), $.$get$ListGroupItem().call$0().call$1("Vestibulum at eros")), document.querySelector(".component-demo__mount--list-group"));
      t9 = $.$get$render();
      t8 = $.div;
      t1 = P.LinkedHashMap__makeEmpty();
      t2 = $.$get$Progress().call$0();
      t2.set$showCaption(true);
      t3 = new A.DomProps(null, P.LinkedHashMap__makeEmpty());
      t3.set$className(0, "text-xs-center");
      t2.set$captionProps(t3);
      J.set$caption$x(t2, "Reticulating splines...");
      t2 = t2.call$0();
      t3 = $.$get$Progress().call$0();
      t4 = J.getInterceptor$x(t3);
      t4.set$value(t3, 25);
      t3.set$showCaption(true);
      t5 = new A.DomProps(null, P.LinkedHashMap__makeEmpty());
      t5.set$className(0, "text-xs-center");
      t3.set$captionProps(t5);
      t4.set$caption(t3, "Reticulating splines...");
      t3 = t3.call$0();
      t4 = $.$get$Progress().call$0();
      t5 = J.getInterceptor$x(t4);
      t5.set$value(t4, 50);
      t4.set$showCaption(true);
      t6 = new A.DomProps(null, P.LinkedHashMap__makeEmpty());
      t6.set$className(0, "text-xs-center");
      t4.set$captionProps(t6);
      t5.set$caption(t4, "Reticulating splines...");
      t4 = t4.call$0();
      ...
      t6.set$captionProps(t10);
      t7.set$caption(t6, "Reticulating splines...");
      t9.call$2(new A.DomProps(t8, t1).call$5(t2, t3, t4, t5, t6.call$0()), document.querySelector(".component-demo__mount--progress"));
      t6 = $.$get$render();
      t5 = $.div;
      t1 = P.LinkedHashMap__makeEmpty();
      t2 = $.h1;
      t3 = P.LinkedHashMap__makeEmpty();
      t3 = new A.DomProps(t2, t3).call$2("Example heading ", $.$get$Tag().call$0().call$1("New"));
      t2 = $.h2;
      t4 = P.LinkedHashMap__makeEmpty();
      t4 = new A.DomProps(t2, t4).call$2("Example heading ", $.$get$Tag().call$0().call$1("New"));
      t2 = $.h3;
      t7 = P.LinkedHashMap__makeEmpty();
      t7 = new A.DomProps(t2, t7).call$2("Example heading ", $.$get$Tag().call$0().call$1("New"));
      t2 = $.h4;
      t8 = P.LinkedHashMap__makeEmpty();
      t8 = new A.DomProps(t2, t8).call$2("Example heading ", $.$get$Tag().call$0().call$1("New"));
      t2 = $.h5;
      t9 = P.LinkedHashMap__makeEmpty();
      t9 = new A.DomProps(t2, t9).call$2("Example heading ", $.$get$Tag().call$0().call$1("New"));
      t2 = $.h6;
      t10 = P.LinkedHashMap__makeEmpty();
      t6.call$2(new A.DomProps(t5, t1).call$6(t3, t4, t7, t8, t9, new A.DomProps(t2, t10).call$2("Example heading ", $.$get$Tag().call$0().call$1("New"))), document.querySelector(".component-demo__mount--tag"));
    ...
    UiComponent: {
      ...
      copyUnconsumedDomProps$0: function() {
        var t1, consumedPropKeys;
        t1 = this.get$consumedProps();
        consumedPropKeys = t1 == null ? t1 : H.setRuntimeTypeInfo(new H.MappedListIterable(t1, new S.UiComponent_copyUnconsumedDomProps_closure()), [null, null]);
        if (consumedPropKeys == null)
          consumedPropKeys = C.List_empty;
    ...
    closure9: {
      ...
      }, "call$0", null, null, null, 0, 2, null, 0, 6, "call"]
    },
    ButtonProps: {
      "^": "UiProps0;",
      get$skin: function() {
        return J.$index$asx(this.props, "ButtonProps.skin");
      },
      ...
      get$isActive: function() {
        return J.$index$asx(this.props, "ButtonProps.isActive");
      },
      set$isActive: function(value) {
        J.$indexSet$ax(this.props, "ButtonProps.isActive", false);
        return false;
      },
      ...
      set$isDisabled: function(value) {
        J.$indexSet$ax(this.props, "disabled", false);
        return false;
      },
      get$isBlock: function() {
        return J.$index$asx(this.props, "ButtonProps.isBlock");
      },
      set$isBlock: function(value) {
        J.$indexSet$ax(this.props, "ButtonProps.isBlock", false);
        return false;
      },
      get$href: function(_) {
      ...
      get$type: function(_) {
        return J.$index$asx(this.props, "ButtonProps.type");
      },
      set$type: function(_, value) {
    ...
    ListGroupItemProps: {
      ...
      set$isActive: function(value) {
        J.$indexSet$ax(this.props, "ListGroupItemProps.isActive", false);
        return false;
      },
      get$isDisabled: function() {
        return J.$index$asx(this.props, "disabled");
    ...
    ProgressProps: {
      ...
      set$min: function(_, value) {
        J.$indexSet$ax(this.props, "ProgressProps.min", value);
        return value;
      },
      get$max: function(_) {
      ...
      set$max: function(_, value) {
        J.$indexSet$ax(this.props, "ProgressProps.max", value);
        return value;
      },
      get$skin: function() {
      ...
      set$isStriped: function(value) {
        J.$indexSet$ax(this.props, "ProgressProps.isStriped", false);
        return false;
      },
      ...
      set$isAnimated: function(value) {
        J.$indexSet$ax(this.props, "ProgressProps.isAnimated", false);
        return false;
      },
      ...
      set$showPercentComplete: function(value) {
        J.$indexSet$ax(this.props, "ProgressProps.showPercentComplete", true);
        return true;
      },
    ...
    ProgressComponent: {
      ...
      getDefaultProps$0: function() {
        ...
        t1.set$min(0, 0);
        t1.set$max(0, 100);
        t1.set$skin(C.ProgressSkin_Wzh);
        t1.set$isStriped(false);
        t1.set$isAnimated(false);
        t1.set$showCaption(false);
        t1.set$showPercentComplete(true);
        return t1;
      },
    ...
    TagProps: {
      ...
      set$isPill: function(value) {
        J.$indexSet$ax(this.props, "TagProps.isPill", false);
        return false;
      },
      $isMap: 1,
      $asMap: Isolate.functionThatReturnsNull
    ...
    Component: {
      ...
      initStateInternal$0: function() {
        this.set$state(0, P.LinkedHashMap_LinkedHashMap$from(this.getInitialState$0(), null, null));
    ...
    ReactDartComponentFactoryProxy: {
      ...
      }, "call$1", null, null, "get$$call", 2, 2, null, 0, 14, 18],
      noSuchMethod$1: [function(_, invocation) {
        var props, children;
        if (J.$eq$(invocation.get$memberName(), C.Symbol_call) && invocation.get$isMethod() === true) {
    ...
    _initComponent: {
      ...
      }, null, null, 6, 0, null, 40, 1, 42, "call"]
    },
    ...
    _convertEventHandlers__closure: {
      ...
      }, "call$2", null, null, null, null, 2, 4, null, 0, 0, 7, 49, 20, "call"]
    },
    ...
    }, "call$2", "js_interop_helpers___getProperty$closure", 4, 0, 11, 19, 2],
    _setProperty: [function(jsObj, key, value) {
      return self._setProperty(jsObj, key, value);
    }, "call$3", "js_interop_helpers___setProperty$closure", 6, 0, 51, 19, 2, 3],
    jsify: function(map) {
      var jsMap = {};
  ...
  C.ButtonSkin_0 = new L.ButtonSkin("btn-warning", "WARNING");
  C.ButtonSkin_MYu = new L.ButtonSkin("btn-link", "LINK");
  C.ButtonSkin_ccO = new L.ButtonSkin("btn-danger", "DANGER");
  C.ButtonSkin_pm8 = new L.ButtonSkin("btn-primary", "PRIMARY");
  C.ButtonSkin_qRH = new L.ButtonSkin("btn-success", "SUCCESS");
  C.ButtonSkin_sEs = new L.ButtonSkin("btn-secondary", "SECONDARY");
  C.ButtonSkin_wqt = new L.ButtonSkin("btn-info", "INFO");
...
;
  ...
  C.PropDescriptor_0 = new S.PropDescriptor("ButtonProps.size", false, false, "");
  ...
  C.List_aZ8 = Isolate.makeConstantList([C.PropDescriptor_Y71, C.PropDescriptor_0, C.PropDescriptor_c0B, C.PropDescriptor_rLL, C.PropDescriptor_8qt, C.PropDescriptor_j7r, C.PropDescriptor_uo3, C.PropDescriptor_M9u]);
  ...
  (function(lazies) {
    ...
    return new L.closure9();
  }, "Button", "$ButtonComponentFactory", "$get$$ButtonComponentFactory", function() {
    return S.registerComponent(new L.closure10(), $.$get$Button(), C.Type_ButtonComponent_gsm, "Button", false, null);
  }, "$ButtonComponentFactory", "ListGroup", "$get$ListGroup", function() {
    return new L.closure7();
    ...
    return S.registerComponent(new L.closure8(), $.$get$ListGroup(), C.Type_ListGroupComponent_k6K, "ListGroup", false, null);
  ...
  }, "ListGroupItemElementType_SPAN", "ListGroupItemHeaderElementSize_H5", "$get$ListGroupItemHeaderElementSize_H5", function() {
    ...
    return S.registerComponent(new L.closure6(), $.$get$ListGroupItem(), C.Type_ListGroupItemComponent_RoN, "ListGroupItem", false, null);
  }, "$ListGroupItemComponentFactory", "Progress", "$get$Progress", function() {
    return new L.closure3();
  }, "Progress", "$ProgressComponentFactory", "$get$$ProgressComponentFactory", function() {
    return S.registerComponent(new L.closure4(), $.$get$Progress(), C.Type_ProgressComponent_36D, "Progress", false, null);
  }, "$ProgressComponentFactory", "Tag", "$get$Tag", function() {
    return new L.closure();
  }, "Tag", "$TagComponentFactory", "$get$$TagComponentFactory", function() {
    return S.registerComponent(new L.closure0(), $.$get$Tag(), C.Type_TagComponent_IjT, "Tag", false, null);
    ...
    return new R.closure11();
  }, "render"]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = [null, "internal", "key", "value", "error", "invocation", "backingProps", "e", "stackTrace", "callback", "nextInternal", "_", "v", "k", "props", "element", "data", "x", "children", "jsObj", "event", "result", "object", "arg3", "a", "b", "arg", "n", "consumedProps", "prop", "isolate", "line", "namespace", "subkey", "arguments", "sender", C.List_empty, "child", "numberOfArguments", "instance", "jsThis", "arg2", "componentStatics", "name", "pair", "each", "prevInternal", "closure", "propKey", "domId", "arg4", "obj", "arg1"];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, ret: A.DomProps}, {func: 1, args: [P.String]}, {func: 1, opt: [P.Map]}, {func: 1, ret: K.ReactElement, args: [P.Map], opt: [,]}, {func: 1, v: true, args: [K.ReactDartComponentInternal]}, {func: 1, v: true, args: [K.ReactDartComponentInternal, K.ReactDartComponentInternal]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.String]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [S.ConsumedProps]}, {func: 1, args: [V.Component, K.ReactDartComponentInternal]}, {func: 1, v: true, args: [V.Component]}, {func: 1, ret: P.String, args: [K.ReactElement]}, {func: 1, ret: [P.List, W.RtcStatsReport]}, {func: 1, v: true, opt: [P.Object]}, {func: 1, args: [P.String,,]}, {func: 1, args: [S.PropDescriptor]}, {func: 1, ret: K.ReactElement, opt: [,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,]}, {func: 1, args: [P.Iterable]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, args: [P.bool]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [K.ReactComponent]}, {func: 1, v: true, args: [K.ReactComponent, K.ReactDartComponentInternal, K.ComponentStatics]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, args: [{func: 1}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.bool, args: [K.ReactDartComponentInternal, K.ReactDartComponentInternal]}, {func: 1, args: [K.ReactDartComponentInternal]}, {func: 1, ret: P.Future}, {func: 1, ret: P.Object, opt: [P.Object]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1}]}, {func: 1, ret: P.$int, args: [P.Comparable, P.Comparable]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.Object]}, {func: 1, ret: {func: 1, ret: K.ReactElement, args: [P.Map], opt: [,]}, args: [{func: 1, ret: V.Component}], opt: [[P.Iterable, P.String]]}, {func: 1, ret: V.SyntheticClipboardEvent, args: [Q.SyntheticClipboardEvent0]}, {func: 1, ret: V.SyntheticKeyboardEvent, args: [Q.SyntheticKeyboardEvent0]}, {func: 1, ret: V.SyntheticFocusEvent, args: [Q.SyntheticFocusEvent0]}, {func: 1, ret: V.SyntheticFormEvent, args: [Q.SyntheticFormEvent0]}, {func: 1, ret: V.SyntheticMouseEvent, args: [Q.SyntheticMouseEvent0]}, {func: 1, ret: V.SyntheticTouchEvent, args: [Q.SyntheticTouchEvent0]}, {func: 1, ret: V.SyntheticUIEvent, args: [Q.SyntheticUIEvent0]}, {func: 1, ret: V.SyntheticWheelEvent, args: [Q.SyntheticWheelEvent0]}, {func: 1, args: [, P.String,,]}, {func: 1, ret: K.ReactComponent, args: [K.ReactElement, W.Element]}, {func: 1, ret: P.bool, args: [W.Element]}, {func: 1, args: [Q.SyntheticEvent0], opt: [P.String, W.Event]}];
