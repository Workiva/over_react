...
(function() {
  ...
  init();
  init.mangledNames = {set$props: "props=", get$props: "props", call$0: "call:0", call$1: "call:1", call$1$growable: "call:0:growable", call$2: "call:2", call$3: "call:3", call$4: "call:4", call$6: "call:6", call$7: "call:7", componentFactory$0: "componentFactory:0"};
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, null, null, 14, 0, null, 33, 14, 15, 17, 29, 32, 41],
    ...
    Primitives_functionNoSuchMethod_closure: {
      "^": "Closure:19;_box_0,$arguments,namedArgumentList",
    ...
    }, "call$2", "core_Comparable_compare$closure", 4, 0, 26],
    ...
    EventTarget: {
      "^": "Interceptor;",
      $isEventTarget: 1,
      "%": "Animation|ApplicationCache|AudioContext|BatteryManager|CrossOriginServiceWorkerClient|DOMApplicationCache|DataChannel|EventSource|FileReader|IDBDatabase|IDBOpenDBRequest|IDBRequest|IDBTransaction|IDBVersionChangeRequest|MIDIAccess|MediaController|MediaQueryList|MediaSource|MediaStream|MediaStreamTrack|MessagePort|Notification|OfflineAudioContext|OfflineResourceList|Performance|PermissionStatus|Presentation|PresentationSession|RTCDTMFSender|RTCDataChannel|RTCPeerConnection|ServicePortCollection|ServiceWorkerContainer|ServiceWorkerRegistration|SpeechRecognition|SpeechSynthesis|SpeechSynthesisUtterance|StashedMessagePort|StashedPortCollection|WebSocket|WorkerPerformance|XMLHttpRequest|XMLHttpRequestEventTarget|XMLHttpRequestUpload|mozRTCPeerConnection|webkitAudioContext|webkitRTCPeerConnection;EventTarget;EventTarget_ListMixin|EventTarget_ListMixin_ImmutableListMixin|EventTarget_ListMixin0|EventTarget_ListMixin_ImmutableListMixin0"
    },
    FieldSetElement: {
    ...
    main: function() {
      ...
      t1.call$2(t2.call$7(t3, t4, t5, t6, t7, t8, t9.call$1("Link")), document.querySelector(".component-demo__mount--button-examples"));
      t9 = $.$get$render();
      t8 = $.div;
      t1 = new A.DomProps(t8, P.LinkedHashMap__makeEmpty());
      t1.set$className(0, "btn-toolbar");
      t2 = $.$get$Button().call$0().call$1("Button");
      t3 = $.$get$Button().call$0();
      J.set$href$x(t3, "#");
      t3 = t3.call$1("Link");
      t4 = $.$get$Button().call$0();
      J.set$type$x(t4, C.ButtonType_submit_SUBMIT);
      t4 = t4.call$1("Submit");
      t5 = $.$get$Button().call$0();
      J.set$type$x(t5, C.ButtonType_reset_RESET);
      t9.call$2(t1.call$4(t2, t3, t4, t5.call$1("Reset")), document.querySelector(".component-demo__mount--button-types"));
      t5 = $.$get$render();
      t4 = $.div;
      t1 = new A.DomProps(t4, P.LinkedHashMap__makeEmpty());
      t1.set$className(0, "btn-toolbar");
      t2 = $.$get$Button().call$0();
      t2.set$skin(C.ButtonSkin_tEV);
      t2 = t2.call$1("Primary");
      t3 = $.$get$Button().call$0();
      t3.set$skin(C.ButtonSkin_r5M);
      t3 = t3.call$1("Secondary");
      t4 = $.$get$Button().call$0();
      t4.set$skin(C.ButtonSkin_GL7);
      t4 = t4.call$1("Success");
      t6 = $.$get$Button().call$0();
      t6.set$skin(C.ButtonSkin_ECn);
      t6 = t6.call$1("Info");
      t7 = $.$get$Button().call$0();
      t7.set$skin(C.ButtonSkin_heQ);
      t7 = t7.call$1("Warning");
      t8 = $.$get$Button().call$0();
      t8.set$skin(C.ButtonSkin_C3c);
      t5.call$2(t1.call$6(t2, t3, t4, t6, t7, t8.call$1("Danger")), document.querySelector(".component-demo__mount--button-outline"));
      t8 = $.$get$render();
      t7 = $.div;
      t1 = new A.DomProps(t7, P.LinkedHashMap__makeEmpty());
      t1.set$className(0, "btn-toolbar");
      t2 = $.$get$Button().call$0();
      J.set$size$x(t2, C.ButtonSize_6FR);
      t2 = t2.call$1("Small");
      t3 = $.$get$Button().call$0().call$1("Default");
      t4 = $.$get$Button().call$0();
      J.set$size$x(t4, C.ButtonSize_NAq);
      t8.call$2(t1.call$3(t2, t3, t4.call$1("Large")), document.querySelector(".component-demo__mount--button-sizes"));
      t4 = $.$get$render();
      t3 = $.div;
      t1 = P.LinkedHashMap__makeEmpty();
      t2 = $.$get$Button().call$0();
      t2.set$isBlock(true);
      t2 = t2.call$1("Block level button");
      t5 = $.$get$Button().call$0();
      t5.set$isBlock(true);
      t5.set$skin(C.ButtonSkin_sEs);
      t4.call$2(new A.DomProps(t3, t1).call$2(t2, t5.call$1("Block level button")), document.querySelector(".component-demo__mount--button-block"));
      t5 = $.$get$render();
      t2 = $.div;
      t1 = new A.DomProps(t2, P.LinkedHashMap__makeEmpty());
      t1.set$className(0, "btn-toolbar");
      t2 = $.$get$Button().call$0();
      t2.set$isActive(true);
      t2 = t2.call$1("Primary button");
      t3 = $.$get$Button().call$0();
      t3.set$isActive(true);
      t3.set$skin(C.ButtonSkin_sEs);
      t5.call$2(t1.call$2(t2, t3.call$1("Button")), document.querySelector(".component-demo__mount--button-active"));
      t3 = $.$get$render();
      t2 = $.div;
      t1 = new A.DomProps(t2, P.LinkedHashMap__makeEmpty());
      t1.set$className(0, "btn-toolbar");
      t2 = $.$get$Button().call$0();
      t2.set$isDisabled(true);
      t2 = t2.call$1("Primary button");
      t4 = $.$get$Button().call$0();
      J.set$href$x(t4, "#");
      t4.set$isDisabled(true);
      t4.set$skin(C.ButtonSkin_sEs);
      t3.call$2(t1.call$2(t2, t4.call$1("Link")), document.querySelector(".component-demo__mount--button-disabled"));
    }
    ...
    }, "call$0", "dom_components_Dom_a$closure", 0, 0, 7],
    Dom_button: [function() {
      var t1 = $.button;
      return new A.DomProps(t1, P.LinkedHashMap__makeEmpty());
    }, "call$0", "dom_components_Dom_button$closure", 0, 0, 7],
    DomProps: {
    ...
    }, "call$1", "pretty_print___prettyObj$closure", 2, 0, 27, 19],
    ...
    closure: {
      ...
      }, "call$0", null, null, null, 0, 2, null, 2, 25, "call"]
    },
    ButtonProps: {
      "^": "UiProps0;",
      get$skin: function() {
      ...
      set$isActive: function(value) {
        J.$indexSet$ax(this.props, "ButtonProps.isActive", value);
        return value;
      },
      ...
      set$isBlock: function(value) {
        J.$indexSet$ax(this.props, "ButtonProps.isBlock", value);
        return value;
      },
      get$href: function(_) {
    ...
    ButtonComponent: {
      ...
      getDefaultProps$0: function() {
        ...
        t3.$indexSet(t2, "ButtonProps.skin", C.ButtonSkin_pm8);
        t3.$indexSet(t2, "ButtonProps.size", C.ButtonSize_2kV);
        t3.$indexSet(t2, "ButtonProps.isActive", false);
        t3.$indexSet(t2, "disabled", false);
        t3.$indexSet(t2, "ButtonProps.isBlock", false);
        t3.$indexSet(t2, "ButtonProps.type", C.ButtonType_button_BUTTON);
        return t1;
      },
      render$0: function(_) {
        var t1, t2, t3;
    ...
    }, "call$2", "call$1", "react_client___registerComponent$closure", 2, 2, 28, 26],
    ...
    }, "call$1", "react_client__syntheticClipboardEventFactory$closure", 2, 0, 29],
    ...
    }, "call$1", "react_client__syntheticKeyboardEventFactory$closure", 2, 0, 30],
    ...
    }, "call$1", "react_client__syntheticFocusEventFactory$closure", 2, 0, 31],
    ...
    }, "call$1", "react_client__syntheticFormEventFactory$closure", 2, 0, 32],
    ...
    }, "call$1", "react_client__syntheticMouseEventFactory$closure", 2, 0, 33, 10],
    ...
    }, "call$1", "react_client__syntheticTouchEventFactory$closure", 2, 0, 34],
    ...
    }, "call$1", "react_client__syntheticUIEventFactory$closure", 2, 0, 35],
    ...
    }, "call$1", "react_client__syntheticWheelEventFactory$closure", 2, 0, 36],
    ...
    ReactDartComponentFactoryProxy: {
      "^": "ReactComponentFactoryProxy:5;reactClass<,reactComponentFactory,defaultProps",
      get$type: function(_) {
      ...
      }, "call$1", null, null, "get$$call", 2, 2, null, 2, 11, 12],
      noSuchMethod$1: [function(_, invocation) {
        var props, children;
        if (J.$eq$(invocation.get$memberName(), C.Symbol_call) && invocation.get$isMethod() === true) {
    ...
    _initComponent: {
      ...
      }, null, null, 6, 0, null, 35, 0, 30, "call"]
    },
    ...
    _handleShouldComponentUpdate: {
      "^": "Closure:23;zone,_afterPropsChange,_callSetStateCallbacks,_callSetStateTransactionalCallbacks",
      call$2: [function(internal, nextInternal) {
    ...
    _handleComponentWillUpdate: {
      "^": "Closure:4;zone,_afterPropsChange",
      call$2: [function(internal, nextInternal) {
    ...
    _handleComponentDidUpdate: {
      "^": "Closure:4;zone,_callSetStateCallbacks",
    ...
    ReactDomComponentFactoryProxy: {
      "^": "ReactComponentFactoryProxy:5;name,factory",
      get$type: function(_) {
        return this.name;
      },
      call$2: [function(props, children) {
    ...
    _convertEventHandlers_closure: {
      ...
      }, null, null, 4, 0, null, 36, 3, "call"]
    },
    _convertEventHandlers__closure: {
      "^": "Closure:25;zone,value,eventFactory",
      ...
      }, "call$2", null, null, null, null, 2, 4, null, 2, 2, 10, 37, 7, "call"]
    },
    ...
    }, "call$2", "js_interop_helpers___getProperty$closure", 4, 0, 8, 13, 1],
    _setProperty: [function(jsObj, key, value) {
      return self._setProperty(jsObj, key, value);
    }, "call$3", "js_interop_helpers___setProperty$closure", 6, 0, 37, 13, 1, 3],
    jsify: function(map) {
      var jsMap = {};
    ...
    }, "call$2", "react_interop_ReactDom_render$closure", 4, 0, 38, 38, 39],
    ReactDom_unmountComponentAtNode: [function(element) {
      return self.ReactDOM.unmountComponentAtNode(element);
    }, "call$1", "react_interop_ReactDom_unmountComponentAtNode$closure", 2, 0, 39],
  ...
  C.ButtonSize_6FR = new L.ButtonSize("btn-sm", "SMALL");
  C.ButtonSize_NAq = new L.ButtonSize("btn-lg", "LARGE");
  C.ButtonSkin_0 = new L.ButtonSkin("btn-warning", "WARNING");
  C.ButtonSkin_C3c = new L.ButtonSkin("btn-outline-danger", "DANGER_OUTLINE");
  C.ButtonSkin_ECn = new L.ButtonSkin("btn-outline-info", "INFO_OUTLINE");
  C.ButtonSkin_GL7 = new L.ButtonSkin("btn-outline-success", "SUCCESS_OUTLINE");
  C.ButtonSkin_MYu = new L.ButtonSkin("btn-link", "LINK");
  C.ButtonSkin_ccO = new L.ButtonSkin("btn-danger", "DANGER");
  C.ButtonSkin_heQ = new L.ButtonSkin("btn-outline-warning", "WARNING_OUTLINE");
  C.ButtonSkin_pm8 = new L.ButtonSkin("btn-primary", "PRIMARY");
  C.ButtonSkin_qRH = new L.ButtonSkin("btn-success", "SUCCESS");
  C.ButtonSkin_r5M = new L.ButtonSkin("btn-outline-secondary", "SECONDARY_OUTLINE");
  C.ButtonSkin_sEs = new L.ButtonSkin("btn-secondary", "SECONDARY");
  C.ButtonSkin_tEV = new L.ButtonSkin("btn-outline-primary", "PRIMARY_OUTLINE");
  C.ButtonSkin_wqt = new L.ButtonSkin("btn-info", "INFO");
  C.ButtonType_button_BUTTON = new L.ButtonType("button", "BUTTON");
  C.ButtonType_reset_RESET = new L.ButtonType("reset", "RESET");
  C.ButtonType_submit_SUBMIT = new L.ButtonType("submit", "SUBMIT");
...
;
  ...
  $ = new Isolate();
  init.metadata = ["internal", "key", null, "value", "invocation", "nextInternal", "callback", "event", "k", "v", "e", "props", "children", "jsObj", "isolate", "numberOfArguments", "n", "arg1", "prop", "obj", "line", "namespace", "subkey", "pair", "consumedProps", "backingProps", C.List_empty, "instance", "arguments", "arg2", "componentStatics", "name", "arg3", "closure", "prevInternal", "jsThis", "propKey", "domId", "component", "element", "child", "arg4"];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, args: [,,]}, {func: 1, args: [P.String]}, {func: 1, v: true, args: [K.ReactDartComponentInternal, K.ReactDartComponentInternal]}, {func: 1, ret: K.ReactElement, args: [P.Map], opt: [,]}, {func: 1, v: true, args: [K.ReactDartComponentInternal]}, {func: 1, ret: A.DomProps}, {func: 1, args: [, P.String]}, {func: 1, args: [V.Component, K.ReactDartComponentInternal]}, {func: 1, v: true, args: [V.Component]}, {func: 1, args: [S.ConsumedProps]}, {func: 1, ret: P.String, args: [K.ReactElement]}, {func: 1, args: [S.PropDescriptor]}, {func: 1, ret: K.ReactElement, opt: [,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,]}, {func: 1, args: [P.Iterable]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, opt: [P.Map]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [P.String,,]}, {func: 1, args: [K.ReactComponent]}, {func: 1, v: true, args: [K.ReactComponent, K.ReactDartComponentInternal, K.ComponentStatics]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, ret: P.bool, args: [K.ReactDartComponentInternal, K.ReactDartComponentInternal]}, {func: 1, args: [K.ReactDartComponentInternal]}, {func: 1, args: [Q.SyntheticEvent0], opt: [P.String, W.Event]}, {func: 1, ret: P.$int, args: [P.Comparable, P.Comparable]}, {func: 1, ret: P.String, args: [P.Object]}, {func: 1, ret: {func: 1, ret: K.ReactElement, args: [P.Map], opt: [,]}, args: [{func: 1, ret: V.Component}], opt: [[P.Iterable, P.String]]}, {func: 1, ret: V.SyntheticClipboardEvent, args: [Q.SyntheticClipboardEvent0]}, {func: 1, ret: V.SyntheticKeyboardEvent, args: [Q.SyntheticKeyboardEvent0]}, {func: 1, ret: V.SyntheticFocusEvent, args: [Q.SyntheticFocusEvent0]}, {func: 1, ret: V.SyntheticFormEvent, args: [Q.SyntheticFormEvent0]}, {func: 1, ret: V.SyntheticMouseEvent, args: [Q.SyntheticMouseEvent0]}, {func: 1, ret: V.SyntheticTouchEvent, args: [Q.SyntheticTouchEvent0]}, {func: 1, ret: V.SyntheticUIEvent, args: [Q.SyntheticUIEvent0]}, {func: 1, ret: V.SyntheticWheelEvent, args: [Q.SyntheticWheelEvent0]}, {func: 1, args: [, P.String,,]}, {func: 1, ret: K.ReactComponent, args: [K.ReactElement, W.Element]}, {func: 1, ret: P.bool, args: [W.Element]}, {func: 1, args: [{func: 1}]}];
