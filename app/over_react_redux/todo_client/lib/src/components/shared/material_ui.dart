...
ReactElement TrashIcon([Map props = const {}]) {
  return SvgIcon(
    {'aria-label': 'Delete', ...props},
    (Dom.path()..d = 'M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z')(),
  );
}

ReactElement ExpandLessIcon([Map props = const {}]) {
  return SvgIcon(
    {'aria-label': 'Collapse', ...props},
    (Dom.path()..d = 'M12 8l-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z6z')(),
  );
}

ReactElement ExpandMoreIcon([Map props = const {}]) {
  return SvgIcon(
    {'aria-label': 'Expand', ...props},
    (Dom.path()..d = 'M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z')(),
  );
}

ReactElement GroupIcon([Map props = const {}]) {
  return SvgIcon(
    {'aria-label': 'Users', ...props},
    (Dom.path()
      ..d =
...
ReactElement MenuIcon([Map props = const {}]) {
  return SvgIcon(
    {'aria-label': 'Menu', ...props},
    (Dom.path()..d = 'M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z')(),
  );
}
...
ReactElement StorageIcon([Map props = const {}]) {
  return SvgIcon(
    {'aria-label': 'Menu', ...props},
    (Dom.path()..d = 'M2 20h20v-4H2v4zm2-3h2v2H4v-2zM2 4v4h20V4H2zm4 3H4V5h2v2zm-4 7h20v-4H2v4zm2-3h2v2H4v-2z')(),
  );
}
