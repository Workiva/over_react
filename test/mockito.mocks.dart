...
class _FakeLevel extends _i1.Fake implements _i2.Level {}
...
class MockLogger extends _i1.Mock implements _i3.Logger {
  ...
  @override
  _i2.Level get level =>
      (super.noSuchMethod(Invocation.getter(#level), returnValue: _FakeLevel())
          as _i2.Level);
  @override
  set level(_i2.Level? value) =>
  ...
  _i4.Stream<_i5.LogRecord> get onRecord => (super.noSuchMethod(
      ...
      returnValue: Stream<_i5.LogRecord>.empty()) as _i4.Stream<_i5.LogRecord>);
  @override
  void clearListeners() =>
  ...
  @override
  void log(_i2.Level? logLevel, Object? message,
          [Object? error, StackTrace? stackTrace, _i4.Zone? zone]) =>
      super.noSuchMethod(
...
class MockMap<K, V> extends _i1.Mock implements Map<K, V> {
  ...
  Iterable<MapEntry<K, V>> get entries =>
      (super.noSuchMethod(Invocation.getter(#entries),
          returnValue: <MapEntry<K, V>>[]) as Iterable<MapEntry<K, V>>);
  @override
  Iterable<K> get keys =>
      (super.noSuchMethod(Invocation.getter(#keys), returnValue: <K>[])
          as Iterable<K>);
  @override
  Iterable<V> get values =>
      (super.noSuchMethod(Invocation.getter(#values), returnValue: <V>[])
          as Iterable<V>);
  @override
  int get length =>
  ...
  Map<RK, RV> cast<RK, RV>() =>
      (super.noSuchMethod(Invocation.method(#cast, []), returnValue: <RK, RV>{})
          as Map<RK, RV>);
  @override
  bool containsValue(Object? value) =>
      (super.noSuchMethod(Invocation.method(#containsValue, [value]),
          returnValue: false) as bool);
  @override
  ...
  Map<K2, V2> map<K2, V2>(MapEntry<K2, V2> Function(K, V)? convert) =>
      (super.noSuchMethod(Invocation.method(#map, [convert]),
          returnValue: <K2, V2>{}) as Map<K2, V2>);
  @override
  void addEntries(Iterable<MapEntry<K, V>>? newEntries) =>
      super.noSuchMethod(Invocation.method(#addEntries, [newEntries]),
          returnValueForMissingStub: null);
  @override
  V update(K? key, V Function(V)? update, {V Function()? ifAbsent}) =>
      (super.noSuchMethod(
              Invocation.method(#update, [key, update], {#ifAbsent: ifAbsent}),
              returnValue: _i6.mapUpdateShim(key, update, ifAbsent: ifAbsent))
          as V);
  @override
  void updateAll(V Function(K, V)? update) =>
      super.noSuchMethod(Invocation.method(#updateAll, [update]),
          returnValueForMissingStub: null);
  @override
  ...
  V putIfAbsent(K? key, V Function()? ifAbsent) =>
      (super.noSuchMethod(Invocation.method(#putIfAbsent, [key, ifAbsent]),
          returnValue: _i6.mapPutIfAbsentShim(key, ifAbsent)) as V);
  @override
  void addAll(Map<K, V>? other) =>
      super.noSuchMethod(Invocation.method(#addAll, [other]),
          returnValueForMissingStub: null);
  @override
