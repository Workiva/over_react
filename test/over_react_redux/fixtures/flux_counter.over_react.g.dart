...
class FluxCounterProps extends _$FluxCounterProps with _$FluxCounterPropsAccessorsMixin {
  static const PropsMeta meta = _$metaForFluxCounterProps;
}
_$$FluxCounterProps _$FluxCounter([Map? backingProps]) => _$$FluxCounterProps(backingProps);
// Concrete props implementation.
//
// Implements constructor and backing map, and links up to generated component factory.
class _$$FluxCounterProps extends _$FluxCounterProps with _$FluxCounterPropsAccessorsMixin implements FluxCounterProps {
  _$$FluxCounterProps([Map? backingMap]) : this.props = backingMap ?? JsBackedMap();
  ...
  @override
  ReactComponentFactoryProxy get componentFactory => super.componentFactory ?? $FluxCounterComponentFactory;
  ...
  @override
  String $getPropKey(void Function(Map m) accessMap) => _$getPropKey$_$$FluxCounterProps(accessMap, (map) => _$$FluxCounterProps(map));
}
...
class _$FluxCounterComponent extends FluxCounterComponent {
  ...
  @override
  _$$FluxCounterProps typedPropsFactoryJs(JsBackedMap? backingMap) => _$$FluxCounterProps(backingMap);

  @override
  _$$FluxCounterProps typedPropsFactory(Map? backingMap) => _$$FluxCounterProps(backingMap);
  ...
  @override
  final List<ConsumedProps> $defaultConsumedProps = const [_$metaForFluxCounterProps];
}
