...
mixin $UseStoreCounterFnProps on UseStoreCounterFnProps {
  static const PropsMeta meta = _$metaForUseStoreCounterFnProps;
  /* GENERATED CONSTANTS */
...
@Deprecated('This API is for use only within generated code.'
    ' Do not reference it in your code, as it may change at any time.')
const PropsMeta _$metaForUseStoreCounterFnProps = PropsMeta(
  fields: $UseStoreCounterFnProps.$props,
  keys: $UseStoreCounterFnProps.$propKeys,
);
...
@Deprecated('This API is for use only within generated code.'
    ' Do not reference it in your code, as it may change at any time.')
const PropsMeta _$metaForCustomContextUseStoreCounterFnProps = PropsMeta(
  fields: $CustomContextUseStoreCounterFnProps.$props,
...
class _$$UseStoreCounterFnProps extends UiProps
  ...
  _$$UseStoreCounterFnProps(Map? backingMap) : this._props = {} {
...
class _$$CustomContextUseStoreCounterFnProps extends UiProps
  ...
  // This initializer of `_props` to an empty map, as well as the reassignment
  // of `_props` in the constructor body is necessary to work around a DDC bug: https://github.com/dart-lang/sdk/issues/36217
  _$$CustomContextUseStoreCounterFnProps(Map? backingMap) : this._props = {} {
    this._props = backingMap ?? {};
  }
