...
final UiFactoryConfig<_$$LazyLoadMeProps> _$LazyLoadMeConfig = UiFactoryConfig(
  propsFactory: PropsFactory(
    ...
    jsMap: (map) => _$$LazyLoadMeProps(map),
  ),
...
final UiFactoryConfig<_$$LazyLoadMeProps> $LazyLoadMeConfig = _$LazyLoadMeConfig;
...
class _$$LazyLoadMeProps extends UiProps with LazyLoadMePropsMixin,
...
$LazyLoadMePropsMixin implements LazyLoadMeProps {
  _$$LazyLoadMeProps([Map? backingMap]) : this.props = backingMap ?? JsBackedMap();
  ...
  @override
  String $getPropKey(void Function(Map m) accessMap) => _$getPropKey$_$$LazyLoadMeProps(accessMap, (map) => _$$LazyLoadMeProps(map));
}
/// An alias for [getPropKey] so it can be referenced within the props class impl
/// without being shadowed by the `getPropKey` instance extension member.
const _$getPropKey$_$$LazyLoadMeProps = getPropKey;
