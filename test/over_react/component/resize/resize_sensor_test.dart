...
library internal_resize_sensor_test;

import 'dart:async';
import 'dart:html';

import 'package:platform_detect/platform_detect.dart';
import 'package:over_react/over_react.dart' hide ResizeSensor, ResizeSensorProps, ResizeSensorComponent;
...
void main() {
  group('ResizeSensor', () {
    ...
    Element domTarget;
    internal.ResizeSensorComponent resizeSensorRef;
    ...
    void renderSensorIntoContainer({
      ...
      var sensor = (internal.ResizeSensor()
    ...
    group('should render with the correct styles', () {
      test('by default', () {
        var renderedNode = renderAndGetDom(internal.ResizeSensor()());
      ...
      test('when isFlexChild is true', () {
        var renderedNode = renderAndGetDom((internal.ResizeSensor()..isFlexChild = true)());
      ...
      test('when isFlexContainer is true', () {
        var renderedNode = renderAndGetDom((internal.ResizeSensor()..isFlexContainer = true)());
    ...
    group('should hide all of its descendants when isFlexChild is', () {
      ...
      test('false', () {
        var renderedNode = renderAndGetDom((internal.ResizeSensor()..isFlexChild = false)());
        var descendants = renderedNode.querySelectorAll('*');
    ...
    void sharedResizeDetectTests({bool quickMount}) {
      group('when props.quickMount is $quickMount: detects when the bounding rect', () {
        ...
        internal.ResizeSensorProps props;

        setUp(() {
          props = internal.ResizeSensor()
    ...
    group('common component functionality:', () {
      commonComponentTests(internal.ResizeSensor);
    },
