...
_$$WithTransitionTesterProps _$WithTransitionTester([Map? backingProps]) => _$$WithTransitionTesterProps(backingProps);
// Concrete props implementation.
//
// Implements constructor and backing map, and links up to generated component factory.
@Deprecated('This API is for use only within generated code.'
    ' Do not reference it in your code, as it may change at any time.')
class _$$WithTransitionTesterProps extends UiProps with WithTransitionPropsMixin,
...
$WithTransitionPropsMixin,TransitionPropsMixin,
...
$TransitionPropsMixin implements WithTransitionTesterProps {
  _$$WithTransitionTesterProps([Map? backingMap]) : this.props = backingMap ?? JsBackedMap();
  ...
  @override
  ReactComponentFactoryProxy get componentFactory => super.componentFactory ?? $WithTransitionTesterComponentFactory;
  ...
  @override
  String $getPropKey(void Function(Map m) accessMap) => _$getPropKey$_$$WithTransitionTesterProps(accessMap, (map) => _$$WithTransitionTesterProps(map));

  @override
  Set<String> get requiredPropNamesToSkipValidation => const {'isShown', 'transitionTimeout'};
}
...
class _$WithTransitionTesterComponent extends WithTransitionTesterComponent {
  ...
  @override
  _$$WithTransitionTesterProps typedPropsFactoryJs(JsBackedMap? backingMap) => _$$WithTransitionTesterProps(backingMap);

  @override
  _$$WithTransitionTesterProps typedPropsFactory(Map? backingMap) => _$$WithTransitionTesterProps(backingMap);
