...
mixin _$CustomErrorBoundaryPropsAccessorsMixin implements _$CustomErrorBoundaryProps {
  @override
  Map get props;
...
_$$CustomErrorBoundaryProps _$CustomErrorBoundary([Map? backingProps]) => _$$CustomErrorBoundaryProps(backingProps);
// Concrete props implementation.
//
// Implements constructor and backing map, and links up to generated component factory.
class _$$CustomErrorBoundaryProps extends _$CustomErrorBoundaryProps with _$CustomErrorBoundaryPropsAccessorsMixin implements CustomErrorBoundaryProps {
  _$$CustomErrorBoundaryProps([Map? backingMap]) : this.props = backingMap ?? JsBackedMap();
  ...
  @override
  ReactComponentFactoryProxy get componentFactory => super.componentFactory ?? $CustomErrorBoundaryComponentFactory;
  ...
  @override
  String $getPropKey(void Function(Map m) accessMap) => _$getPropKey$_$$CustomErrorBoundaryProps(accessMap, (map) => _$$CustomErrorBoundaryProps(map));
}
/// An alias for [getPropKey] so it can be referenced within the props class impl
/// without being shadowed by the `getPropKey` instance extension member.
const _$getPropKey$_$$CustomErrorBoundaryProps = getPropKey;
mixin _$CustomErrorBoundaryStateAccessorsMixin implements _$CustomErrorBoundaryState {
  @override
  Map get state;
...
class _$$CustomErrorBoundaryState extends _$CustomErrorBoundaryState with _$CustomErrorBoundaryStateAccessorsMixin implements CustomErrorBoundaryState {
  _$$CustomErrorBoundaryState([Map? backingMap]) : this.state = backingMap ?? JsBackedMap();
...
class _$CustomErrorBoundaryComponent extends CustomErrorBoundaryComponent {
  ...
  @override
  _$$CustomErrorBoundaryProps typedPropsFactoryJs(JsBackedMap? backingMap) => _$$CustomErrorBoundaryProps(backingMap);

  @override
  _$$CustomErrorBoundaryProps typedPropsFactory(Map? backingMap) => _$$CustomErrorBoundaryProps(backingMap);
  ...
  @override 
  _$$CustomErrorBoundaryState typedStateFactoryJs(JsBackedMap? backingMap) => _$$CustomErrorBoundaryState(backingMap);

  @override
  _$$CustomErrorBoundaryState typedStateFactory(Map? backingMap) => _$$CustomErrorBoundaryState(backingMap);
  ...
  @override
  final List<ConsumedProps> $defaultConsumedProps = const [_$metaForCustomErrorBoundaryProps];
}
