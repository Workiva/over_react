...
@Deprecated('This API is for use only within generated code.'
    ...
    ' EXCEPTION: this may be used in legacy boilerplate until'
    ' it is transitioned to the new mixin-based boilerplate.')
mixin $DomAccessorPropsMixin on DomAccessorPropsMixin {
  static const PropsMeta meta = _$metaForDomAccessorPropsMixin;
  @override
  @Accessor(key: 'data-random', keyNamespace: '')
  String get aRandomDataAttribute =>
      (props[_$key__aRandomDataAttribute__DomAccessorPropsMixin] ?? null)
          as String;
  @override
  @Accessor(key: 'data-random', keyNamespace: '')
  set aRandomDataAttribute(String value) =>
      props[_$key__aRandomDataAttribute__DomAccessorPropsMixin] = value;
  @override
  @Accessor(key: 'aria-label', keyNamespace: '')
  String get anAriaLabelAlias =>
      (props[_$key__anAriaLabelAlias__DomAccessorPropsMixin] ?? null) as String;
  @override
  @Accessor(key: 'aria-label', keyNamespace: '')
  set anAriaLabelAlias(String value) =>
      props[_$key__anAriaLabelAlias__DomAccessorPropsMixin] = value;
  /* GENERATED CONSTANTS */
  static const PropDescriptor
      _$prop__aRandomDataAttribute__DomAccessorPropsMixin =
      PropDescriptor(_$key__aRandomDataAttribute__DomAccessorPropsMixin);
  static const PropDescriptor _$prop__anAriaLabelAlias__DomAccessorPropsMixin =
      PropDescriptor(_$key__anAriaLabelAlias__DomAccessorPropsMixin);
  static const String _$key__aRandomDataAttribute__DomAccessorPropsMixin =
      'data-random';
  static const String _$key__anAriaLabelAlias__DomAccessorPropsMixin =
      'aria-label';

  static const List<PropDescriptor> $props = [
    _$prop__aRandomDataAttribute__DomAccessorPropsMixin,
    _$prop__anAriaLabelAlias__DomAccessorPropsMixin
  ];
  static const List<String> $propKeys = [
    _$key__aRandomDataAttribute__DomAccessorPropsMixin,
    _$key__anAriaLabelAlias__DomAccessorPropsMixin
  ];
}

@Deprecated('This API is for use only within generated code.'
    ' Do not reference it in your code, as it may change at any time.')
const PropsMeta _$metaForDomAccessorPropsMixin = PropsMeta(
  fields: $DomAccessorPropsMixin.$props,
  keys: $DomAccessorPropsMixin.$propKeys,
);
...
abstract class _$$TestProps extends UiProps
    with
        ...
        $AThirdPropsMixin,
        DomAccessorPropsMixin,
        // If this generated mixin is undefined, it's likely because DomAccessorPropsMixin is not a valid `mixin`-based props mixin, or because it is but the generated mixin was not imported. Check the declaration of DomAccessorPropsMixin, and check that $DomAccessorPropsMixin is exported/imported properly.
        $DomAccessorPropsMixin
    implements
        TestProps {
  _$$TestProps._();
  ...
  PropsMetaCollection get staticMeta => const PropsMetaCollection({
        ...
        // If this generated mixin is undefined, it's likely because DomAccessorPropsMixin is not a valid `mixin`-based props mixin, or because it is but the generated mixin was not imported. Check the declaration of DomAccessorPropsMixin, and check that $DomAccessorPropsMixin is exported/imported properly.
        DomAccessorPropsMixin: $DomAccessorPropsMixin.meta,
      });
}
