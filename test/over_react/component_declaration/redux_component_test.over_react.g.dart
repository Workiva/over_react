...
class _$TestDefaultComponent extends TestDefaultComponent {
  @override
  typedPropsFactory(Map backingMap) => new _$$TestDefaultProps(backingMap);
...
class _$TestConnectComponent extends TestConnectComponent {
  @override
  typedPropsFactory(Map backingMap) => new _$$TestConnectProps(backingMap);
...
class _$TestPureComponent extends TestPureComponent {
  @override
  typedPropsFactory(Map backingMap) => new _$$TestPureProps(backingMap);
