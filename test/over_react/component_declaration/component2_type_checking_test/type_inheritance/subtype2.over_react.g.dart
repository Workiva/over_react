...
final $TestSubtype2ComponentFactory = registerComponent2(
  ...
  isWrapper: false,
  parentType: $TestParent2ComponentFactory, /* from `subtypeOf: TestParent2Component` */
);
...
class TestSubtype2Props extends _$TestSubtype2Props with _$TestSubtype2PropsAccessorsMixin {
...
class _$$TestSubtype2Props extends _$TestSubtype2Props with _$TestSubtype2PropsAccessorsMixin implements TestSubtype2Props {
  _$$TestSubtype2Props([Map? backingMap]) : this.props = backingMap ?? JsBackedMap();
  ...
  @override
  ReactComponentFactoryProxy get componentFactory => super.componentFactory ?? $TestSubtype2ComponentFactory;
  ...
  @override
  String $getPropKey(void Function(Map m) accessMap) => _$getPropKey$_$$TestSubtype2Props(accessMap, (map) => _$$TestSubtype2Props(map));
}
...
class _$TestSubtype2Component extends TestSubtype2Component {
  ...
  @override
  _$$TestSubtype2Props typedPropsFactoryJs(JsBackedMap? backingMap) => _$$TestSubtype2Props(backingMap);

  @override
  _$$TestSubtype2Props typedPropsFactory(Map? backingMap) => _$$TestSubtype2Props(backingMap);
  ...
  @override
  final List<ConsumedProps> $defaultConsumedProps = const [_$metaForTestSubtype2Props];
}
