...
abstract class _$$Foo290Props extends UiProps
    with
        Foo290Props,
        $Foo290Props // If this generated mixin is undefined, it's likely because Foo290Props is not a valid `mixin`-based props mixin, or because it is but the generated mixin was not imported. Check the declaration of Foo290Props, and check that $Foo290Props is exported/imported properly.
{
  _$$Foo290Props._();
