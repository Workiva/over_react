...
_$$StatefulComponentTestProps _$StatefulComponentTest([Map backingProps]) =>
    backingProps == null
        ? _$$StatefulComponentTestProps(JsBackedMap())
...
class _$StatefulComponentTestComponent extends StatefulComponentTestComponent {
  ...
  @override
  _$$StatefulComponentTestProps typedPropsFactoryJs(JsBackedMap backingMap) =>
  ...
  @override
  _$$StatefulComponentTestState typedStateFactoryJs(JsBackedMap backingMap) =>
...
mixin $StatefulComponentTestProps on StatefulComponentTestProps {
  ...
  bool get setStateDirectly =>
      props[_$key__setStateDirectly__StatefulComponentTestProps] ??
...
mixin $StatefulComponentTestState on StatefulComponentTestState {
  ...
  String get stringState =>
      state[_$key__stringState__StatefulComponentTestState] ??
      null; // Add ` ?? null` to workaround DDC bug: <https://github.com/dart-lang/sdk/issues/36052>;
  @override
  ...
  dynamic get dynamicState =>
      state[_$key__dynamicState__StatefulComponentTestState] ??
      null; // Add ` ?? null` to workaround DDC bug: <https://github.com/dart-lang/sdk/issues/36052>;
  @override
  ...
  @override
  get untypedState =>
      state[_$key__untypedState__StatefulComponentTestState] ??
      null; // Add ` ?? null` to workaround DDC bug: <https://github.com/dart-lang/sdk/issues/36052>;
  @override
