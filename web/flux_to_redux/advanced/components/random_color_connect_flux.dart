...
UiFactory<RandomColorConnectFluxProps> ConnectedRandomColorConnectFlux = composeHocs([
  connectFlux<TopLevelStore, RandomColorActions, RandomColorConnectFluxProps>(
      ...
      mapActionsToProps: (actions) => RandomColorConnectFlux()..changeMainBackgroundColor = () => actions.changeMainBackgroundColor(),
    ),
  connectFlux<MidLevelStore, RandomColorActions, RandomColorConnectFluxProps>(
    context: midLevelStoreContext,
    mapStateToProps: (state) => (RandomColorConnectFlux()..blockOneBackgroundColor = state.backgroundColor),
    mapActionsToProps: (actions) => RandomColorConnectFlux()..changeBlockOneBackgroundColor = () => actions.changeBlockOneBackgroundColor(),
  ),
  connectFlux<LowLevelStore, RandomColorActions, RandomColorConnectFluxProps>(
