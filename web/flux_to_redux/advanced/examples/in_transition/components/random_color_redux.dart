...
UiFactory<RandomColorReduxProps> ConnectedRandomColorRedux = composeHocs([
  ...
  connect<InTransitionLowLevelStore, RandomColorReduxProps>(
    ...
    mapStateToProps: (state) => (RandomColorRedux()..blockTwoBackgroundColor = state.backgroundColor),
    mapDispatchToProps: (dispatch) => (RandomColorRedux()
      ..changeBlockTwoBackgroundColor = () {
        dispatch(UpdateBlockTwoBackgroundColorAction());
      }),
  ...
  connect<InTransitionSecondStore, RandomColorReduxProps>(
    ...
    mapStateToProps: (state) => (RandomColorRedux()..blockThreeBackgroundColor = state.backgroundColor),
    mapDispatchToProps: (dispatch) => (RandomColorRedux()
      ..changeBlockThreeBackgroundColor = () {
        dispatch(UpdateBlockThreeBackgroundColorAction());
      }),
