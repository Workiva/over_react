...
mixin _$ProgressPropsAccessorsMixin implements _$ProgressProps {
  ...
  @override
  ProgressSkin? get skin => (props[_$key__skin___$ProgressProps] ?? null) as ProgressSkin?;
  /// The skin / "context" for the [Progress] component.
  ///
  /// See: <http://v4-alpha.getbootstrap.com/components/progress/#contextual-alternatives>.
  ///
  ...
  @override
  bool? get isStriped => (props[_$key__isStriped___$ProgressProps] ?? null) as bool?;
  /// Whether to render a "Barber Pole" gradient stripe effect in the [Progress] component.
  ///
  /// Default: false
  ///
  ...
  @override
  bool? get isAnimated => (props[_$key__isAnimated___$ProgressProps] ?? null) as bool?;
  /// Whether to animate the "Barber Pole" gradient stripe effect in the [Progress] component.
  ///
  /// __Note:__ Has no effect if [isStriped] is `false`.
  ///
  ...
  /// <!-- Generated from [_$ProgressProps.isAnimated] -->
  @override
  set isAnimated(bool? value) => props[_$key__isAnimated___$ProgressProps] = value;
  ...
  @override
  String? get caption => (props[_$key__caption___$ProgressProps] ?? null) as String?;
  /// Optionally add a caption that describes the context of the [Progress] component.
  ///
  /// See: <http://v4-alpha.getbootstrap.com/components/progress/#example>.
  ///
  ...
  @override
  Map? get captionProps => (props[_$key__captionProps___$ProgressProps] ?? null) as Map?;
  /// Additional props to be added to the [caption] element _(if specified)_.
  ///
  /// <!-- Generated from [_$ProgressProps.captionProps] -->
  @override
  set captionProps(Map? value) => props[_$key__captionProps___$ProgressProps] = value;
  ...
  @override
  bool? get showCaption => (props[_$key__showCaption___$ProgressProps] ?? null) as bool?;
  /// Whether the [caption] should be visible.
  ///
  /// Default: false
  ///
  /// <!-- Generated from [_$ProgressProps.showCaption] -->
  @override
  set showCaption(bool? value) => props[_$key__showCaption___$ProgressProps] = value;
  ...
  @override
  bool? get showPercentComplete => (props[_$key__showPercentComplete___$ProgressProps] ?? null) as bool?;
  /// Whether the [caption] should be appended with the value of [value].
  ///
  /// Default: true
  ///
  /// <!-- Generated from [_$ProgressProps.showPercentComplete] -->
  @override
  set showPercentComplete(bool? value) => props[_$key__showPercentComplete___$ProgressProps] = value;
  ...
  @override
  Map? get rootNodeProps => (props[_$key__rootNodeProps___$ProgressProps] ?? null) as Map?;
  /// Additional props to be added to the [Dom.div] that wraps around the [caption] element and `<progress>` element.
  ///
  /// <!-- Generated from [_$ProgressProps.rootNodeProps] -->
  @override
  set rootNodeProps(Map? value) => props[_$key__rootNodeProps___$ProgressProps] = value;
  /* GENERATED CONSTANTS */
  static const PropDescriptor _$prop__value___$ProgressProps = PropDescriptor(_$key__value___$ProgressProps);
  static const PropDescriptor _$prop__min___$ProgressProps = PropDescriptor(_$key__min___$ProgressProps);
  static const PropDescriptor _$prop__max___$ProgressProps = PropDescriptor(_$key__max___$ProgressProps);
  static const PropDescriptor _$prop__skin___$ProgressProps = PropDescriptor(_$key__skin___$ProgressProps);
  static const PropDescriptor _$prop__isStriped___$ProgressProps = PropDescriptor(_$key__isStriped___$ProgressProps);
  static const PropDescriptor _$prop__isAnimated___$ProgressProps = PropDescriptor(_$key__isAnimated___$ProgressProps);
  static const PropDescriptor _$prop__caption___$ProgressProps = PropDescriptor(_$key__caption___$ProgressProps);
  static const PropDescriptor _$prop__captionProps___$ProgressProps = PropDescriptor(_$key__captionProps___$ProgressProps);
  static const PropDescriptor _$prop__showCaption___$ProgressProps = PropDescriptor(_$key__showCaption___$ProgressProps);
  static const PropDescriptor _$prop__showPercentComplete___$ProgressProps = PropDescriptor(_$key__showPercentComplete___$ProgressProps);
  static const PropDescriptor _$prop__rootNodeProps___$ProgressProps = PropDescriptor(_$key__rootNodeProps___$ProgressProps);
  ...
  static const String _$key__isStriped___$ProgressProps = 'ProgressProps.isStriped';
  static const String _$key__isAnimated___$ProgressProps = 'ProgressProps.isAnimated';
  static const String _$key__caption___$ProgressProps = 'ProgressProps.caption';
  static const String _$key__captionProps___$ProgressProps = 'ProgressProps.captionProps';
  static const String _$key__showCaption___$ProgressProps = 'ProgressProps.showCaption';
  static const String _$key__showPercentComplete___$ProgressProps = 'ProgressProps.showPercentComplete';
  static const String _$key__rootNodeProps___$ProgressProps = 'ProgressProps.rootNodeProps';

  static const List<PropDescriptor> $props = [_$prop__value___$ProgressProps, _$prop__min___$ProgressProps, _$prop__max___$ProgressProps, _$prop__skin___$ProgressProps, _$prop__isStriped___$ProgressProps, _$prop__isAnimated___$ProgressProps, _$prop__caption___$ProgressProps, _$prop__captionProps___$ProgressProps, _$prop__showCaption___$ProgressProps, _$prop__showPercentComplete___$ProgressProps, _$prop__rootNodeProps___$ProgressProps];
  static const List<String> $propKeys = [_$key__value___$ProgressProps, _$key__min___$ProgressProps, _$key__max___$ProgressProps, _$key__skin___$ProgressProps, _$key__isStriped___$ProgressProps, _$key__isAnimated___$ProgressProps, _$key__caption___$ProgressProps, _$key__captionProps___$ProgressProps, _$key__showCaption___$ProgressProps, _$key__showPercentComplete___$ProgressProps, _$key__rootNodeProps___$ProgressProps];
}
...
_$$ProgressProps _$Progress([Map? backingProps]) => _$$ProgressProps(backingProps);
// Concrete props implementation.
//
// Implements constructor and backing map, and links up to generated component factory.
class _$$ProgressProps extends _$ProgressProps with _$ProgressPropsAccessorsMixin implements ProgressProps {
  _$$ProgressProps([Map? backingMap]) : this.props = backingMap ?? JsBackedMap();
  ...
  @override
  ReactComponentFactoryProxy get componentFactory => super.componentFactory ?? $ProgressComponentFactory;
  ...
  @override
  String $getPropKey(void Function(Map m) accessMap) => _$getPropKey$_$$ProgressProps(accessMap, (map) => _$$ProgressProps(map));

  @override
  Set<String> get requiredPropNamesToSkipValidation => const {'value', 'min', 'max', 'skin', 'isStriped', 'isAnimated', 'showCaption', 'showPercentComplete'};
}
...
mixin _$ProgressStateAccessorsMixin implements _$ProgressState {
  ...
  /* GENERATED CONSTANTS */
  static const StateDescriptor _$prop__id___$ProgressState = StateDescriptor(_$key__id___$ProgressState);
...
class _$$ProgressState extends _$ProgressState with _$ProgressStateAccessorsMixin implements ProgressState {
  _$$ProgressState([Map? backingMap]) : this.state = backingMap ?? JsBackedMap();
...
class _$ProgressComponent extends ProgressComponent {
  @override
  _$$ProgressProps typedPropsFactory(Map? backingMap) => _$$ProgressProps(backingMap);

  @override
  _$$ProgressState typedStateFactory(Map? backingMap) => _$$ProgressState(backingMap);
  ...
  @override
  final List<ConsumedProps> $defaultConsumedProps = const [_$metaForProgressProps];
}
