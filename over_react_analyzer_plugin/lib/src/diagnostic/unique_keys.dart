...
class UniqueKeysDiagnostic extends ComponentUsageDiagnosticContributor {
  ...
  static final dynamicOrObjectCode = DiagnosticCode(
      ...
      "Key is of type '{0}', meaning the instance may not have a unique toString.",
      AnalysisErrorSeverity.WARNING,
      AnalysisErrorType.STATIC_WARNING);
  ...
  static final debug = DiagnosticCode(
      '___debug',
      "{0}",
      AnalysisErrorSeverity.WARNING,
      AnalysisErrorType.STATIC_WARNING);
  ...
  computeErrorsForUsage(result, collector, usage) async {
    forEachCascadedProp(usage, (lhs, rhs) {
      ...
      collector.addError(debug, errorLocation, errorMessageArgs: ['keyType: ${keyType == result.typeProvider.nullType}  ${keyType.element}']);
