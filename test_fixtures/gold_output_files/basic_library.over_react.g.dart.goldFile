...
class _$BasicPartOfLibComponent extends BasicPartOfLibComponent {
  @override
  typedPropsFactory(Map backingMap) => new _$$BasicPartOfLibProps(backingMap);

  @override
  typedStateFactory(Map backingMap) => new _$$BasicPartOfLibState(backingMap);
...
class _$SubPartOfLibComponent extends SubPartOfLibComponent {
  @override
  typedPropsFactory(Map backingMap) => new _$$SubPartOfLibProps(backingMap);
