...
styleMissingUnit() {
  ...
  (Dom.div()
    ..style = {
      ...
      'minHeight':
          three, // Cannot lint currently since its not const, but also should not cause analyzer errors
      'height': '1' '2',
      'top': '${1}',
      'left': 1,
    }
...
class SomeWidgetWithBadStylesComponent
    extends UiComponent2<SomeWidgetWithBadStylesProps> {
  static const ten = '10';
