...
import 'classish.dart';
import 'util.dart';

export 'classish.dart';
...
extension NameHelper on Identifier {
  ...
  bool get isFunctionType => ['uiFunction', 'uiForwardRef', 'uiJsComponent'].contains(name);
}
...
extension SourceFileSpanHelper on SourceFile {
  ...
  FileSpan spanFor(SyntacticEntity nodeOrToken) =>  _getSpanForEntity(nodeOrToken);
