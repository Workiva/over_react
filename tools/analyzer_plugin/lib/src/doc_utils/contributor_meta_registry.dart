...
mixin ContributorMetaRegistry<T extends DocumentedContributorMetaBase> on IterableMixin<T> {
  /// A table mapping contributor names to contributors.
...
class AssistMetaRegistry extends IterableMixin<DocumentedAssistContributorMeta>
    with ContributorMetaRegistry<DocumentedAssistContributorMeta> {
...
class DiagnosticMetaRegistry extends IterableMixin<DocumentedDiagnosticContributorMeta>
    with ContributorMetaRegistry<DocumentedDiagnosticContributorMeta> {
